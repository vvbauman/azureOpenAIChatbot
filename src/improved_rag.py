...
def get_config():
    ...
    oai_client = AzureOpenAI(
        ...
        base_url = f"{oai_endpoint}/openai/deployments/{oai_deployment}/extensions",
        api_key = oai_key,
...
def main():
    ...
    while q < max_questions: # STEP 1) Facilitate a 3-turn conversation
        ...
        query_messages = build_messages(
            model = deployment_name, # double check if deployment name (str) is what we want to pass here
            ...
            user_request_query = "Generate search query for: " + text,
        ...
        search_results = search_client.search(
            ...
            top=3, # number of search results to retrieve
            query_type="simple",
            )
        
        # TODO: get search results
        # below is how to get results:
        ...
        messages = build_messages(
            ...
            new_user_content=text + search_results,
